        ...
        <div class="row">
            ...
            <div class="col-md-8">
              ...
              $page_1 = ($page * 5) - 5;
                  ...
                  $query = "select * from posts where post_status='Public' ORDER BY post_id DESC limit $page_1, 5";
                  $query1 ="select * from posts where post_status='Public'";
                        ...
                        if ($i == $page) {
                          ?>
                            <li style="margin-right:5px;">
                              <a style="background-color:#000" href="index.php?page=<?php echo $i ?>"><?php echo $i ?></a>
                            </li>
                          <?php
                        }
                        else {
