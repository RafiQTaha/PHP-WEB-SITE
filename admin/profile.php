                          ...
                          <small><?php echo $_SESSION['firstname'] ?></small>
                                    ...
                                    if (isset($_POST['update_user'])) {
                                      ...
                                      if (!empty($password)) {
                                        ...
                                        echo "<h4 class='bg-success'>Goooooooooooood</h4>";
                                          }
                                       else {
                                         echo "<h4 class='bg-success'>Please In Your Password</h4>";
                                       }
                                      }
                                     ...
                                     <form class="form" action="" method="POST" enctype="multipart/form-data">
                                           ...
                                           <div class="form-group">
                                                 ...
                                                 <input type="file" name="user_image" style="border-bottom:1.5px solid black;padding:8px;">
                                           </div>
                                           <div class="form-group">
