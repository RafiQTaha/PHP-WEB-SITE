            ...
            <tbody>
              ...
              <tr>
                    ...
                    $count_comment = mysqli_num_rows($count_comment_query);
                     ?>
                    <td><a href="comments.php?source=post_comments&id=<?php echo $post_id ?>"><?php echo $count_comment ?> <i class="glyphicon glyphicon-comment" style="float : right"></i></a></td>
                    <td><a href="posts.php?reset=<?php echo $post_id ?>"><?php echo $post_views_count ?> <i class="glyphicon glyphicon-eye-open" style="float : right"></i></a></td>
                    <td width="100px"><?php echo $post_date ?></td>
                    <td><a href="posts.php?source=edit_post&p_id=<?php echo $post_id ?>"><i class="glyphicon glyphicon-pencil"></i></a></td> <!-- Edit -->
                    <td><a onClick="javascript: return confirm('Are You Sure You Want To Delete This Post ?!');" href="posts.php?delete=<?php echo $post_id ?>" ><i class="glyphicon glyphicon-trash"></i></a></td>
              </tr>
            <?php $x = $x + 1; }  ?>
            </tbody>
          </table>
